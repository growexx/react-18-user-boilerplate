...
Automate the creation of components, containers, routes, selectors and slices -
...
to their home screen. Combined with offline caching, this means your web app can
